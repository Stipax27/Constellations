namespace drawer
{
    ...
    void drawWorld()
    {
        ...
        drawСonstellation(UrsaMajor, UrsaMajor_indeces, UrsaMajor_health);
        drawСonstellation(Cancer,Cancer_indices, Cancer_health);
        drawСonstellation(Taurus,Taurus_indices, Taurus_health);
        drawСonstellation(Leo,Leo_indices, Leo_health);
        drawСonstellation(Gemini,Gemini_indices, Gemini_health);
        ...
        drawСonstellation(Virgo,Virgo_indices, Virgo_health);
        drawСonstellation(Scorpius,Scorpius_indices, Scorpius_health);
        drawСonstellation(Sagittarius,Sagittarius_indices, Sagittarius_health);
        drawСonstellation(Capricornus,Capricornus_indices, Capricornus_health);
        drawСonstellation(Aquarius,Aquarius_indices, Aquarius_health);
        drawСonstellation(Pisces,Pisces_indices, Pisces_health);
