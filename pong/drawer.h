namespace drawer
{
    ...
    void drawWorld()
    {
        ...
        //drawСonstellation(Cancer, Cancer_health);
        //drawСonstellation(Taurus, Taurus_health);
        //drawСonstellation(Leo, Leo_health);
        //drawСonstellation(Gemini, Gemini_health);
        drawСonstellation(LibraCopy1, Libra_edges, Libra_health);
        drawHeroСonstellation(LibraHeroCopy, Libra_edges, Libra_health);

        //drawСonstellation(Libra, Libra_edges, Libra_health);

        //drawСonstellation(Virgo, Virgo_health);
        //drawСonstellation(Scorpius, Scorpius_health);
        //drawСonstellation(Sagittarius, Sagittarius_health);
        //drawСonstellation(Capricornus, Capricornus_health);
        //drawСonstellation(Aquarius, Aquarius_health);
        //drawСonstellation(Pisces, Pisces_health);
