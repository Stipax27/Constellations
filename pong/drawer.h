namespace drawer
{
    ...
    void drawWorld()
    {
        ...
        drawСonstellation(Aries);
        drawСonstellation(Taurus);
        drawСonstellation(Gemini);
        drawСonstellation(Cancer);
        drawСonstellation(Leo);
        drawСonstellation(Virgo);
        drawСonstellation(Libra);
        drawСonstellation(Scorpius);
        drawСonstellation(Sagittarius);
        drawСonstellation(Capricornus);
        drawСonstellation(Aquarius);
        drawСonstellation(Pisces);
