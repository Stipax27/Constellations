...
{ 
    ...
    void drawPlayerСonstellationToMenu()
    {
        ...
        drawСonstellation(*entities[player_sign].constellation);
    ...
    void drawWorld()
    {
        ...
        switch (gameState)
        {
            ...
            case gameState_::selectEnemy:
            {
                ...
                for (int i = 0;i < 12;i++)
                {
                    drawСonstellation(*entities[i].constellation);
                }
            ...
            case gameState_::Fight:
            {
                ...
                if (!GetAsyncKeyState(VK_LBUTTON))
                {
                    ...
                    drawСonstellation(*entities[currentEnemyID].constellation);
                    ...
                    drawСonstellation(*entities[player_sign].constellation,true);//Игрок
                ...
                drawСonstellation(*entities[player_sign].constellation, true);
