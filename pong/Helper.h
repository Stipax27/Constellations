void Helpers() 
{
	...
	drawString("Element selection:\nButton Z - Fire \nButton X - Earth \nButton C - Air \nButton V - Water", (1700. / 2560) * window.width, (900. / 1440) * window.height, .7f, false);
	...
	drawString("Press T to quit", window.width / 2, window.height /2, 1, true);
